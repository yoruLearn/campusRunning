<template>
  <div class="app-container">
    ...
    <el-table @row-click="clickRow" ref="tableRef" highlight-current-row
              border v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
...
<script setup>
import { listNotice, getNotice, delNotice, addNotice, updateNotice } from "@/api/take/notice"
...
const data = reactive({
  ...
  rules: {
    noticeId: [
      { required: true, message: "通知公告ID不能为空", trigger: "blur" }
    ],
    title: [
